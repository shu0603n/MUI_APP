...
import ListSmallCard from '../client/exportpdf/ListSmallCard';
        ...
        <Grid id="print" container spacing={2.25}>
          <Grid item xs={12}>
            ...
            >
              ...
              <MenuItem onClick={handleAdd}>編集</MenuItem>
              <MenuItem onClick={handleAlertClose}>削除</MenuItem>
            </Menu>
          </Grid>
          <Grid item xs={12}>
            <Divider />
          ...
          <Grid item xs={12}>
            <Typography>こんにちは、{customer.about}</Typography>
          </Grid>
          <Grid item xs={12}>
