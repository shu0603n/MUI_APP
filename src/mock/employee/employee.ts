...
export const MockEmployee: Employee = {
  ...
  job_category: MockJobCategory, //職種
  client: '株式会社テクノプロ', //顧客ID
  project: MockProject, //案件
  ...
  remarks: 'ストレスに弱い', //備考
  position: MockPosition3, //役職ID
  employment: MockEmployment //雇用ID
};
