...
const EmployeeDetail = () => {
  ...
  let selectedTab = 0;
  switch (pathname) {
    case '/apps/employee/account/personal':
      selectedTab = 1;
      break;
    case '/apps/employee/account/my-account':
      selectedTab = 2;
      break;
    case '/apps/employee/account/password':
      selectedTab = 3;
      break;
    case '/apps/employee/account/role':
      selectedTab = 4;
      break;
    case '/apps/employee/account/settings':
      selectedTab = 5;
      break;
    case '/apps/employee/account/basic':
    default:
      selectedTab = 0;
  }
